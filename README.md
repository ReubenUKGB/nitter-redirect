...
|<img width="32" height="32" alt="reddit-icon-color" src="https://github.com/user-attachments/assets/aca193d0-fd46-4f47-ace9-53433b8ff921" />|`http://`, `https://`|`reddit.com`, `*.reddit.com`, `old.reddit.com` excluded|`*`|Redlib|`redlib.perennialte.ch`|`True`|
